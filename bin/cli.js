...
(() => {
  ...
  const ciphers = [
    { name: "Substitution Cipher", call: cipherjs.Substitution, args: [{ n: 'Key',   t: 'string'  }] }
  ];
  ...
  const quitChoices = [new inquirer.Separator(), { name: 'Exit', value: -1 }];
  ...
  print();
  print(bold('Substitution Demo - CLI'));
  print(bold('---------------'));
